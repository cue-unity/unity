	...
	on: {
		push: {
			branches: list.Concat([[
					// Unfortunately we need to leave this pattern in for now
					// because the main branch of unity does not trigger
					// trybots by creating a PR. We will remove in the "next" CL.
					"trybot/*/*/*/*",
